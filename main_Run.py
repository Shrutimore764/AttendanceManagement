    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='Shruti@007', db='manually_fill_attendance')
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='Shruti@007', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                cs = 'C:/Users/SHRUTI/OneDrive/Desktop/Attendance project/StudentDetails/StudentDetails.csv'
